...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    try {
      yield mongoose_1.default.connect(uriLocal);
...
app.get("/getall/:number", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (
        excludedUser === null || excludedUser === void 0
          ? void 0
          : excludedUser.receiverNumber
      ) {
        res.json({
          status: "error",
          message:
...
app.put("/update/:giverId/:receiverId", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
    ...
    try {
      ...
      return new Promise((resolve, reject) => {
        ...
        const writeStream = doc.pipe(
          fs_1.default.createWriteStream("./document.pdf"),
        );
        ...
        doc
          .font("Helvetica")
          .text(
            `Family Gift exchange list made on ${(0, moment_1.default)(new Date()).format("DD-MM-YYYY____HH:mm:ss")}`,
            {
              align: "center",
            },
          );
